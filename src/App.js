...
const css=`
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
  ...
  /* LOGIN */
  .login-screen{display:flex;flex-direction:column;height:100vh;position:relative;overflow:hidden;}
  .login-bg{position:absolute;inset:0;background:#000;}
  .login-bg img{width:100%;height:100%;object-fit:cover;opacity:0.4;}
  .login-overlay{position:absolute;inset:0;background:linear-gradient(to bottom,rgba(0,0,0,0.2) 0%,rgba(0,0,0,0.8) 60%,#000 100%);}
  ...
  .login-title{font-family:'Bebas Neue',sans-serif;font-size:4rem;line-height:0.9;letter-spacing:0.02em;margin-bottom:0.8rem;}
  .login-sub{font-size:0.75rem;color:rgba(255,255,255,0.4);text-transform:uppercase;letter-spacing:0.18em;margin-bottom:2rem;}
  ...
  .login-note{font-size:0.6rem;color:rgba(255,255,255,0.2);text-align:center;margin-top:0.8rem;letter-spacing:0.08em;text-transform:uppercase;}
    ...
    <>
      ...
      <div className="login-screen">
        ...
        <div className="login-content">
          ...
          <h1 className="login-title">FUEL<br/>YOUR<br/><span style={{WebkitTextFillColor:"transparent",WebkitTextStroke:"1.5px #fff"}}>GRIND.</span></h1>
